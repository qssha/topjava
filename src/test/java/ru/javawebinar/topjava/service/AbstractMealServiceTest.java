...
public abstract class AbstractMealServiceTest extends AbstractServiceTest<Meal> {
    ...
    public void createWithException() throws Exception {
        validate(List.of(new Meal(null, of(2015, Month.JUNE, 1, 18, 0), "  ", 300),
                new Meal(null, null, "Description", 300),
                new Meal(null, of(2015, Month.JUNE, 1, 18, 0), "Description", 9),
                new Meal(null, of(2015, Month.JUNE, 1, 18, 0), "Description", 5001)));
    }
}